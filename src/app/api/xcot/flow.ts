...
6. **VALORES FINANCEIROS E MILHARES PARA LEITURA DE VOZ:** Escreva SEMPRE valores em milhares usando a palavra "mil" ou por extenso (ex: "vinte e dois mil reais", "vinte mil reais", "sessenta e quatro mil reais", "quatro mil e quinhentos reais", "quinhentos reais e vinte centavos"). É TERMINANTEMENTE PROIBIDO escrever números contábeis com pontos ou zeros como "22.000", "20.000", "22.000,00", "4.000,00" ou "22000", pois o sintetizador de voz lê como "vinte zero zero zero". Escreva sempre exatamente como se fala: "vinte e dois mil reais".
